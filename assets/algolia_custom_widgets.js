(function (algolia) {
    ...
    var TYPES_TO_WIDGET = {
        ...
        meta_spcecifications_product_dimensions_inch_width: {
            name: 'priceRanges',
            params: {
                labels: {
                    separator: 'x'
        ...
        meta_spcecifications_product_dimensions_mm_width: {
            name: 'priceRanges',
            params: {
                labels: {
                    separator: 'x'
        ...
        meta_spcecifications_product_dimensions_inch_height: {
            name: 'priceRanges',
            params: {
                labels: {
                    separator: 'x'
        ...
        meta_spcecifications_product_dimensions_mm_height: {
            name: 'priceRanges',
            params: {
                labels: {
                    separator: 'x'
        ...
        meta_spcecifications_product_dimensions_inch_depth: {
            name: 'priceRanges',
            params: {
                labels: {
                    separator: 'x'
        ...
        meta_spcecifications_product_dimensions_mm_depth: {
            name: 'priceRanges',
            params: {
                labels: {
                    separator: 'x'
    ...
    algolia.facetsWidgets = _.map(algolia.shownFacets, function (facet) {
        ...
        if (typeof widget.params === 'object' && typeof widget.params.cssClasses === 'object') {
            params.cssClasses = Object.assign({}, algolia.facetCssClasses, widget.params.cssClasses);
        }
        if (facet.searchable) {
